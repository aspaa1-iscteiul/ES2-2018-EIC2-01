...
public class BinaryAlgorithms extends JMetalAlgorithms {
	...
	if (!MULTI_OBJECTIVE.contains(algorithm))
	    throw new IllegalArgumentException(
		    algorithm + " is not a valid multiobjective algorithm for BinaryProblem");

	try {
	    Method method = getClass().getMethod("get" + algorithm, BinaryProblem.class);
	...
	if (!SINGLE_OBJECTIVE.contains(algorithm))
	    throw new IllegalArgumentException(
		    algorithm + " is not a valid singleobjective algorithm for BinaryProblem");
